...
public:
	...
	NSString* getContentType()                              { return mContentType.get() ? mContentType.get() : mRequest.get().contentType; }
	NSString* getContentDisposition() const					{ return mRequest.get().contentDisposition; }
	NSString* getUrlPath()                                  { return mUrlPath.get(); }
	NSString* getHttpMethod()                               { return mHttpMethod.get(); }
