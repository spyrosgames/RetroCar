 ...
 * with some modifications from http://forum.unity3d.com/threads/35484-MiniJSON-script-for-parsing-JSON-data
 */
/// <summary>
...
public class MiniJSON
{
	...
	{
		if (value == null) {
			//TODO:  Treating null values as empty strings.  Is this really ok?
			builder.Append("\"\"");
			return true;
		}
