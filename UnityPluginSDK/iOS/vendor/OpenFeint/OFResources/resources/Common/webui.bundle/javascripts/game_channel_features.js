...
(function() {
  ...
  GameListPromotionBase = (function() {
    ...
    GameListPromotionBase.prototype.buttonListener = function() {
      var $this, index, marketIdentifer;
      $this = $(this);
  ...
  Firesale = (function() {
    ...
    Firesale.prototype.getSavings = function() {
      return (this.promotion.original_price - this.promotion.discount_price).toFixed(2);
    };
  ...
  Interstitial = (function() {
    ...
    Interstitial.prototype.showFiresaleInterstitial = function() {
      ...
      if (this.isVotingOn) {
        ...
        this.interstitialPane.find(".buy_icon_copy").text("Save $" + (this.firesale.getSavings()));
  ...
  Game = (function() {
    ...
    Game.prototype.userHasThisGame = function() {
  ...
  FiresalePage = (function() {
    ...
    FiresalePage.prototype.socialPostOptions = function(firesaleGame) {
      var name, savings;
      savings = (firesaleGame.original_price - firesaleGame.discount_price).toFixed(2);
    ...
    FiresalePage.prototype.render = function(data) {
      ...
      switch (this.vote_state) {
        ...
        case "sale_on":
          ...
          savings = (promotion.original_price - promotion.discount_price).toFixed(2);
