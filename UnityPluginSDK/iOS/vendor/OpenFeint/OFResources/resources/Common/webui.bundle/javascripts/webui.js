...
(function() {
  ...
  scripts = ['jquery', 'template', 'underscore', 'webui-helper', 'webui-core', 'webui-page', 'webui-api', 'webui-action', 'webui-touch', 'webui-analytics', 'webui-pagestack', 'webui-control-tabs'];
