...
#import "OpenFeint/OFNewAccountController.h"
...
@implementation OFNewAccountController (OFXFlow)
- (void)continueFlow
{
	[OpenFeint setDoneWithGetTheMost:YES];
    if([OpenFeint loggedInUserHasHttpBasicCredential] || areIntroFlowViewsHidden) {
