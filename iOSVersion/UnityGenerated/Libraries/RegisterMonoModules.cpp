...
extern "C"
{
	...
	const char*			UnityIPhoneRuntimeVersion = "3.2.0f4"; /* targetDevice = 0 */
...
#endif // !(TARGET_IPHONE_SIMULATOR)
	mono_dl_register_symbol("_UnityBridge_sendMessage", (void*)&_UnityBridge_sendMessage);
}
